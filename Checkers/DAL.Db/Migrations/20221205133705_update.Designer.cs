...
namespace DAL.Db.Migrations
{
    ...
    [Migration("20221205133705_update")]
            ...
            modelBuilder.Entity("Domain.CheckersGameState", b =>
                {
                    ...
                    b.Property<int?>("CheckersStateId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Domain.CheckersGameState", b =>
                {
                    ...
                    b.HasOne("Domain.CheckersState", null)
                        .WithMany("CheckersGameStates")
                        .HasForeignKey("CheckersStateId");
